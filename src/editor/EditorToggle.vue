...
<template>
  <div class="flex cursor-pointer items-center gap-1 rounded-2 px-2 py-1 text-sm font-600 transition-colors hover:bg-zinc-300 dark:hover:bg-zinc-700" title="Edit status" @click="toggleEditorStatus">
